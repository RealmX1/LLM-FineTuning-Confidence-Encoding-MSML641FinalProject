...
def main():
    ...
    for i in range(len(df)):
        for j in range(len(df)):
            ...
            print(user_message)
            llm_message = compare_confidence(user_message, model=model_name).content
    ...
    csv_file_path = f'data/comparison_result_{datetime_str}_{model_name}.csv'  # You can change the file path as needed
